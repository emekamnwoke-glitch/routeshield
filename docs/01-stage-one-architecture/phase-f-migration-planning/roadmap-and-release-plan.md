...
| **v1.2.0** Disruption engine | T1 (part) | Declare a disruption on the map and see every affected route, vehicle and stop | AC-02, AC-04, snapshot freeze, static synthetic fleet scene, A0 impact view in workspace | BS-1 to impact |
| **v1.3.0** Routing engine — **MVP** | T1 | Get ranked options with costs, approve or reject, and reconstruct the decision later | AC-05 (worker), AC-06, AC-07, AC-08, AC-14 personas, reconstruction view | BS-1 to decision |
